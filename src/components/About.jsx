    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-screen mt-[5%] pt-[10%] pb-[10%] bg-[#2B2B29] p-10">
        <p className="text-white text-center text-lg md:text-xl lg:text-2xl leading-relaxed max-w-3xl">
          ...
          Cuento con  2 años de experiencia en el área de desarrollo de software, en los cuales he trabajado en proyectos de desarrollo web tanto en el front-end como en el back-end, utilizando tecnologías como React, Laravel, Flask,vuejs Tailwind CSS, entre otras.
          Soy un desarrollador  que esta en constante aprendizaje para mejorar mis habilidades en el desarrollo de software.
